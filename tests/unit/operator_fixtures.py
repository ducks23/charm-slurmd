...
# -*- coding: utf-8 -*-
# vim:fenc=utf-8
# Copyright © 2020 OmniVector admin@omnivector.solutions
...
import ops
import ops.main
from src.charm import SlurmdCharm
...
class OperatorTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        charm = SlurmdCharm(framework, None)
        self.charm = charm
    ...
    def get_notice_count(self, hook):
        ...
        notice_count = 0
        handle = "SlurmdCharm/on/{}".format(hook)
